...
<head>
    ...
    <title>Dress | AmO T-Shirts</title>
...
<?php  
    ...
    $produtos = mysqli_query($con, "SELECT * FROM produto WHERE categoria = 'Dress'");
...
<div id="contact-page" class="container">
        <div class="bg">
            <div class="row">           
                <div class="col-sm-12">                         
                    <h2 class="title text-center">DRESS <strong>SHIRTS</strong></h2>                                                      
