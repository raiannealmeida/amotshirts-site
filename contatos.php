...
<head>
    ...
    <title>Contatos | AmO T-shirts</title>
...
<body>
	...
	<div id="contact-page" class="container">
        <div class="bg">
            <div class="row">           
                <div class="col-sm-12">                         
                    <h2 class="title text-center"><strong>CONTATOS</strong></h2>
	    		...
	    		<div class="col-sm-8">
	    			<div class="contact-form">
	    				<h4 class="title text-center">Envie uma Mensagem</h4></br>
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
				            ...
				            <div class="form-group col-md-12">
				                <textarea name="message" id="message" required="required" class="form-control" rows="8" placeholder="Escreva sua mensagem"></textarea>
				            </div>                        
				            <div class="form-group col-md-12">
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				<h4 class="title text-center">ENDEREÇO</h4></br>
	    				<address>
	    					<p>PETROLINA- PE</p>
							<p>Rua Dormentes, nº 13</p>
							<p>Bairro Gercino Coelho</p>
							<p>Email: amotshirts@gmail.com</p>
							<p>Telefone: 74 - 9 9110-7434</p>
	    				</address>
	    				<div class="social-networks">
	    					<h4 class="title text-center">REDES SOCIAIS</h4></br>
							<ul>
								<li>
									<a href="https://www.facebook.com/amoteeshirts/?ref=aymt_homepage_panel" target=_black><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://www.instagram.com/amoteeshirts/" target=_black> <i class="fa fa-instagram"></i></a>
								</li>
							</ul>
	    				</div>
	    			</div>
