...
<head>
    ...
    <title>Produtos | AmO T-Shirts</title>
...
<body>
    ...
    <div id="contact-page" class="container">
        <div class="bg">
            <div class="row">           
                <div class="col-sm-12">                        
                    <h2 class="title text-center"><strong>Lista de Produtos</strong></h2>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              foreach($produtos as $produto){ ?>
                ...
                <tr>
                    <th><?php echo $produto['cod'] ?></th>
                    <td><?php echo $produto['nome'] ?></td>
                    <td><?php echo $produto['qnt'] ?></td>
                    <td>R$<?php echo $produto['preco'] ?>,00</td>
                    <td><?php echo $produto['categoria'] ?></td>
                    <td>
                 <?php echo "<a href='excluir_pro.php?cod=".$produto['cod']."' onclick=\"return confirm('Deseja excluir este produto?');\">excluir<i class=cart_delete></i></a>"; 
                 ?></td>
                  <td><?php echo "<a href='editar_pro.php?cod=".$produto['cod']."' >editar<i class=icon-th-list></i></i></a>"; ?></td>
