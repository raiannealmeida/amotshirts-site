...
<head>
    ...
    <title>Sobre | AmO T-shirts</title>
...
<body>
	...
	<div id="contact-page" class="container">
        <div class="bg">
            <div class="row">           
                <div class="col-sm-12">                         
                    <h2 class="title text-center">SOBRE A <strong>EMPRESA</strong></h2> 
                    <ul class="nav nav-pills nav-stacked">
                    <div class="address">
                	<h4>A AmO T-Shirts é uma Empresa virtual de vestuário que preza pela melhor qualidade de atendimento aos seus clientes e dos seus produtos, disponibilizando de um site catálogo, com todos os seus produtos disponíveis na loja, a fim de proporcionar aos seus clientes um acesso fácil e sem precisar sair de casa. </h4>
                	</ul>
                	</div>
            </div>
        </div>                                                     
