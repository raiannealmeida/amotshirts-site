...
<head>
    ...
    <title>Tshirts | AmO T-shirts</title>
...
<?php  
    ...
    $produtos = mysqli_query($con, "SELECT * FROM produto WHERE categoria = 'T-shirt'");
...
<body>
	...
	<div id="contact-page" class="container">
        <div class="bg">
            <div class="row">           
                <div class="col-sm-12">                         
                    <h2 class="title text-center">T <strong>SHIRTS</strong></h2>                                                      
