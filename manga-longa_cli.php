...
<head>
    ...
    <title>Manga Longa | AmO T-Shirts</title>
 ...
 <?php include("verificaSessao.php"); 
    ...
    $produtos = mysqli_query($con, "SELECT * FROM produto WHERE categoria = 'Manga Longa'");
...
<body>
	...
	<div id="contact-page" class="container">
        <div class="bg">
            <div class="row">           
                <div class="col-sm-12">                         
                    <h2 class="title text-center">MANGA <strong>LONGA</strong></h2>                                                      
