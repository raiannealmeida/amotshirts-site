...
<head>
    ...
    <title>Regatas | AmO T-Shirts</title>
 ...
 <?php include("verificaSessao.php"); 
	...
	$produtos = mysqli_query($con, "SELECT * FROM produto WHERE categoria = 'Regata'");
...
<body>
	...
	<div id="contact-page" class="container">
        <div class="bg">
            <div class="row">           
                <div class="col-sm-12">                         
                    <h2 class="title text-center">REGATAS<strong></strong></h2>            
