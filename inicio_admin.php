...
<div id="contact-page" class="container">
        <div class="bg">
            <div class="row">           
                <div class="col-sm-12">                         
                    <h2 class="title text-center"><strong>ÁREA ADMINISTRATIVA</strong></h2>
                    <strong><center><h2>Olá, Administrador(a) <?php echo $_SESSION['login'] ?>.
                    </br>Seja bem Vindo(a)!
                    <img src="anuncio/amot.jpg" class="girl img-responsive" alt="" />
