...
<head>
    ...
    <title>Clientes | AmO T-Shirts</title>
...
<div id="contact-page" class="container">
        <div class="bg">
            <div class="row">           
                <div class="col-sm-12">                         
                    <h2 class="title text-center"><strong>Clientes</strong></h2>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                 <?php echo "<a href='excluir_cliente.php?cpf_cliente=".$cliente['cpf_cliente']."' onclick=\"return confirm('Deseja excluir este cliente?');\">excluir<i class=cart_delete></i></a>"; ?></td>
                </tr>
